...
class AIService:
    ...
    async def generate_analysis(
        ...
        **kwargs
        ...
        """
        GŁÓWNA METODA: Generuje kompletną analizę sprzedażową
        
        Zachowuje API compatibility z oryginalnym ai_service.py
        ale używa wyspecjalizowanych serwisów wewnętrznie.
        ...
        Args:
            ...
            holistic_profile: DNA Klienta (opcjonalne)
            **kwargs: Dodatkowe argumenty dla compatibility
        ...
        try:
            ...
            # Sprawdź czy mamy holistyczny profil
            customer_archetype = kwargs.get('customer_archetype')
            psychology_profile = kwargs.get('session_psychology')  # Legacy compatibility
            
            # Użyj SalesStrategyService do wygenerowania strategii
            ...
            logger.info("✅ [ORCHESTRATOR] Generate_analysis completed")
            return strategy
            
        except Exception as e:
            logger.error(f"❌ [ORCHESTRATOR] Błąd w generate_analysis: {e}")
            # Fallback - użyj quick response
