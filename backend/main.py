...
from app.routers import clients, sessions, interactions, feedback, knowledge, dojo, stream
...
app.include_router(stream.router, prefix="/api/v1")  # WebSocket streaming
